...
export default function DashboardFull() {
  ...
  const fetchSummary = async () => {
    try {
      const res = await axios.get("https://mern-backend2-production.up.railway.app/dash/admin/summary", {
  ...
  const fetchOrdersByDate = async () => {
    try {
      const res = await axios.get(
        "https://mern-backend2-production.up.railway.app/dash/admin/orders-by-date",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get(
        "https://mern-backend2-production.up.railway.app/category/allCategories",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const fetchProducts = async (page = 1) => {
    try {
      const res = await axios.get(
        `https://mern-backend2-production.up.railway.app/products?limit=${pagination.limit}&page=${page}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editProduct) {
        await axios.patch(
          `https://mern-backend2-production.up.railway.app/products/update/${editProduct._id}`,
          payload,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        ...
        await axios.post(
          "https://mern-backend2-production.up.railway.app/products/addproducts",
          payload,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
  ...
  const handleStockChange = async (id, newStock) => {
    ...
    try {
      await axios.patch(
        `https://mern-backend2-production.up.railway.app/products/update/${id}`,
        { stock: newStock },
        {
          headers: { Authorization: `Bearer ${token}` },
        }
            ...
            <div className="confirm-actions">
              <button
                ...
                onClick={async () => {
                  try {
                    await axios.delete(
                      `https://mern-backend2-production.up.railway.app/products/delete/${confirmDelete.id}`,
                      { headers: { Authorization: `Bearer ${token}` } }
                    );
